...
![](/assets/880b27b49f124e12bede3a32a097856e0.png?0.8026179698746074)  
...
![](/assets/880b27b49f124e12bede3a32a097856e1.png?0.11896074414068236)  
...
' Structurizr.SystemLandscapeView: ГлавноеПредставление
title System Landscape for OMyGod

LAYOUT_WITH_LEGEND()

Enterprise_Boundary(OMyGod, "OMyGod") {
}
Rel(Вася__1a3aeba, СуперСистема__f96fc5, "Очень хитрым способом")
@enduml
...
' Structurizr.SystemContextView: Представление-От-Системы
title Супер-Система - System Context

LAYOUT_WITH_LEGEND()

Enterprise_Boundary(OMyGod, "OMyGod") {
  Person(Вася__1a3aeba, "Вася", "Хороший человек")
  System(СуперСистема__f96fc5, "Супер-Система", "специально для Васи")
Rel(Вася__1a3aeba, СуперСистема__f96fc5, "Использует очень хитрым способом")
}
@enduml
